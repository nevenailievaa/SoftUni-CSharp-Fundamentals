...
//You like driving new cars only, so if a car's mileage reaches 100 000 km, remove
//it from the collection(s) and print: "Time to sell the {car}!"
...
//10 000 km and DO NOT print anything.
